...
public class GroupMember {
    ...
    public GroupMember(int id, int id_studenta, int id_grupy, int studenci_id_studenta,
                       int grupy_id_grupy, int grupy_id_egzaminatora1,
                       int studenci_id_studenta1, int grupy_id_grupy1,
                       int grupy_egzaminatorzy_id_egzaminatora) {
        this.id = id;
